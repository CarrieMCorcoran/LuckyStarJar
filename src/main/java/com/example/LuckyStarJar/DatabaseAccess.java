...
public class DatabaseAccess 
{
    ...
    public static Jar getjar(int jarID) throws SQLException
    {
        ...
        sql = "SELECT jar.* " +
        "FROM Jar " +
        "WHERE jarID = " + jarID + " AND jar.wasOpened = 0;";
        ...
        while(results.next())
        {
            ...
            j = new Jar(jarID, openDate, remFreq,inviteCode, jarName, lastReminderDate);
        }
    ...
    */
    public static User getUser (String email) throws SQLException
    {
        ...
        /*
    User getUser(int userID)- returns a User object that matches the given userID, 
    or null if there's no user with that id.
    */
    public static User getUser (int userID) throws SQLException
    {
        ...
        while(results.next())
        {
            ...
            name = results.getString("userName");
            userGoogleAuthInfo = results.getString("userGoogleAuthInfo");
            email = results.getString("userEmail");
    ...
    */
    public static User getUserJarData(int userID, int jarID) throws SQLException
    {
        Connection con;
        Statement st;
        ResultSet results;
        ...
        "JOIN userjar ON user.userID = userjar.userID\n" +
        "WHERE user.userID = " + userID + " AND userjar.jarID = " + jarID + ";";
        ...
        while(results.next())
        {
            ...
            u = new User(userID,name,userGoogleAuthInfo,email,userJarID,noteColor,isJarOwner);
